...
# API pour les commentaires (AJAX)
@csrf_exempt
@require_POST
def add_comment(request):
    ...
    if request.content_type == 'application/json':
        ...
        if post_slug and name and email and content:
            ...
            return JsonResponse({
                ...
                'comment': {
                    ...
                    'created_date': comment.created_date.strftime('%d %B %Y à %H:%M'),
...
def search_ajax(request):
    ...
    if query:
        ...
        results = [{
            ...
            'date': post.published_date.strftime('%d %B %Y') if post.published_date else ''
        } for post in posts]
